...
export default class ShipTestLibrary extends Phaser.State {
    ...
    create() {
        ...
        textBox.addText(new Text("Eines Tages musste Kapitän Sir Lorcan für einen kurzen Zeitraum das Luftschiff verlassen und übergab seinem Lieblingsschüler Damian die Verantwortung für die Kapitäns-Bibliothek. Damian bekam somit als einziger den Schlüssel zu dieser Bibliothek. Er durfte jedes Buch lesen bis auf das goldene Buch aus der Kapitäns-Bibliothek. Falls er sich nicht an dieses Gebot hielt, drohte ihm der Austritt der Luftritter. Als er alleine in der Bibliothek war, sah er sich fast jedes Buch an, doch seine Neugier wurde immer größer. Er dachte sich, dass es doch niemand merken würde, wenn er dieses goldene Buch nur einmal kurz in den Händen hielt..."));
