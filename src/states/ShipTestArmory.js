...
export default class ShipTestArmory extends Phaser.State {
    ...
    create() {
        ...
        textBox.addText(new Text("Eines Tages musste Kapitän Sir Lorcan für einen kurzen Zeitraum das Luftschiff verlassen und übergab seinem Lieblingsschüler Damian die Verantwortung für die Kapitäns-Waffenkammer. Damian bekam somit als einziger den Schlüssel zu dieser Waffenkammer. Er durfte jede Waffe ausprobieren bis auf das goldene Schwert aus der Kapitäns-Waffenkammer. Falls er sich nicht an dieses Gebot hielt, drohte ihm der Austritt der Luftritter. Als er alleine in der Waffenkammer war, sah er sich fast jede Waffe an, doch seine Neugier wurde immer größer. Er dachte sich, dass es doch niemand merken würde, wenn er dieses goldene Schwert nur einmal kurz in den Händen hielt..."));
